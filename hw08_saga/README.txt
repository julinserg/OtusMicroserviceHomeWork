...
1. Для реализации распределенных транзакции использован паттерн "сага хореографией". Для обмена сообщениями в рамках этого паттерна выбран брокер сообщений RabbitMQ.
